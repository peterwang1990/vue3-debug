...
//   42: 'kovan'
// }
var ChainNativeCurrency = function (_a) {
    var _b = _a.name, name = _b === void 0 ? '' : _b, _c = _a.symbol, symbol = _c === void 0 ? '' : _c, _d = _a.decimals, decimals = _d === void 0 ? 18 : _d;
...
var BLOCKCHAIN_CONFIG = {
    ...
    MAX_UINT256: bignumber_1.BigNumber.from(2).pow(bignumber_1.BigNumber.from(256)).sub(bignumber_1.BigNumber.from(1)),
    MAX_INT256: bignumber_1.BigNumber.from(2).pow(bignumber_1.BigNumber.from(255)).sub(bignumber_1.BigNumber.from(1)),
    MIN_INT256: bignumber_1.BigNumber.from(2).pow(bignumber_1.BigNumber.from(255)).sub(bignumber_1.BigNumber.from(-1)),
    bidTimeout: {
        1: 60 * 60 * 4,
        42: 60 * 60 * 4,
        128: 60 * 60 * 4,
...
exports["default"] = BLOCKCHAIN_CONFIG;
